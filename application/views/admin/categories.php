                ...
                <tbody>
                    <?php if ($query !== FALSE): ?>
                        ...
                        <tr>
                                ...
                                <td>
                                    <center>
                                        <button style="display:inline;" class="btn btn-primary btn-md" data-toggle="modal" data-target="#editModal_<?php echo $row->id; ?>"> <span class="glyphicon glyphicon-pencil"> </span> </button>
                                        ...
                                        <button type="submit" name="action" class="btn btn-danger btn-md"> <span class="glyphicon glyphicon-trash"></span></button>
                                        </form>
                                    </center>
                                </td>
                        </tr>
